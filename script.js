  ...
  news: [
    {
      ...
      date: '2026.04.08',
      title: '「月刊りりひな」3月号発売',
      description: 'りりあちゃんのコラムはLINE風のイラスト、漫画はスマホ型の可愛いデザイン。りりあちゃんの画像生成のすごさをぜひ見て欲しいな！ひなこちゃんの衣装プロンプトは今回もいろんなAIで作成してて、見比べるのも楽しいよ！もちろん安藤家総出演の他もコラムの面白さもぶっちぎり！',
      link: 'https://ririhina.booth.pm/items/8174718'
    },
    {
      id: '20260302',
      date: '2026.03.02',
      title: '「月刊りりひな」2月号発売',
      description: '今月はvチューバーりりあのおもしろ配信が漫画で登場、ひなこちゃんの姫路で過ごすバレンタイン特集など盛りだくさん！Galleryも充実。編集部からはnotebookLMで自分探しなど、AIの最前線の内容が盛りだくさん',
      link: 'https://ririhina.booth.pm/items/8047142'
    },
    {
      id: '20260131',
      date: '2026.01.31',
      title: '「月刊りりひな」1月号！',
      description: '今月も楽しいコラムやりりあちゃんのサークル紹介、美麗なイラストなど盛りだくさん！詳細はBoothページをチェックしてください。',
